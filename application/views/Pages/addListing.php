                    ...
                    <div class="sidebar mb-0">
                        ...
                        <div class="widget">
                            <div class="widget-title bg-primary">
                                <h6 class="text-white mb-0"> <i class="far fa-address-book"></i> General Information:
                                </h6>
                            </div>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="row mt-4">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="address" class="form-control" placeholder="" id="autocomplete">
                                    </div>
                                    <!-- <div class="mb-3 col-md-6">
                            ...
                            <div class="widget-content">
                              ...
                              <div class="control-group form-group col-lg-6 col-md-6 product_mainimage">
                                 <div class="controls">
                                    ...
                                    <img alt="osahan logo" id="output" style="width:100%;" src="<?php echo base_url('assets/images/placeholder2.jpg')?>">
                                    <input type="file" name="imageone" required="" class="form-control" onchange="loadFile(event)">
                                    <script>
                              ...
                              <div class="row product_images">
                                <div class="col-md-6 ">
                                <img alt="osahan logo" id="output2" style="width:100%;" src="<?php echo base_url('assets/images/placeholder2.jpg')?>">
                                    <input type="file" name="image2" class="form-control" onchange="loadFile2(event)">
                                </div>
                                  <script>
                                ...
                                <div class="col-md-6">
                                <img alt="osahan logo" id="output3" style="width:100%;" src="<?php echo base_url('assets/images/placeholder2.jpg')?>">
                                    <input type="file" name="image3"  class="form-control" onchange="loadFile3(event)">
                                </div>
                                <script>
                                ...
                                <div class="col-md-6 ">
                                <img alt="osahan logo" id="output4" style="width:100%;" src="<?php echo base_url('assets/images/placeholder2.jpg')?>">
                                    <input type="file" name="image4" class="form-control" onchange="loadFile4(event)">
                                </div>
                                <script>
                                ...
                                <div class="col-md-6 ">
                                <img alt="osahan logo" id="output5" style="width:100%;" src="<?php echo base_url('assets/images/placeholder2.jpg')?>">
                                    <input type="file" name="image5" class="form-control" onchange="loadFile5(event)">
                                </div>
                                <script>
                            ...
                            <div class="widget-content">
                                <div class="row align-items-end">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="pintrest" class="form-control" placeholder="Pinterest ">
                                    </div>
                                    <div class="mb-3 col-md-6">
...
<script src="https://maps.google.com/maps/api/js?key=AIzaSyBUj0JGBQxd8ANDzpXJvKbZCVYJ8LiDkF8&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
<script>
