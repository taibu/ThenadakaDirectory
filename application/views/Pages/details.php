...
<body>
    ...
    <?php
            ...
            ?>
    <section class="page-title bg-holder bg-overlay-black-50" style="background: url(<?php echo base_url('assets/images/bg/01.jpg')?>);">
        <div class="container">
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-9">
                    ...
                    <a class="listing-loaction text-dark mb-3 d-block" href="listing-single-01.html#"><?php echo $addetails['Category']; ?></a>

                            <div class="d-sm-flex d-block">
              <span class="px-2 border text-success border-success border-radius d-inline-block me-2"><?php echo $average; ?></span>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="listing-detail-page">
                                    ...
                                    <div class="slick-list draggable" style="padding: 0px 50px;">
                                        <div class="slick-track"
                                            ...
                                            <div class="slick-slide slick-cloned" data-slick-index="-6" id=""
                                                ...
                                                <div><img class="img-fluid" src="<?php echo base_url('assets/images/gallery/06.jpg')?>" alt=""
                                                        style="width: 100%; display: inline-block;"></div>
                                            </div>
                        ...
                        <div class="listing-detail-box mb-3">
                            <div class="detail-title">
                                <h5>Listing 5 Reviews For Honey Restaurant <span style="padding:4px;border-radius:5px;" class="bg-success text-white me-2 pull-right"><?php echo $average ?>  Rating</span> </h5>
                            </div>
                            <?php if($ratings->num_rows()>0){
                                $i=1;
                            foreach($ratings->result() as $row){ 
