          ...
          <div class="row mt-3 mt-lg-5">
            ...
            <div class="col-sm-8 col-lg-8 col-xl-8">
              <div class="form-group mb-3 mb-lg-0 form-location">
                <span>What ?</span>
                <input type="text" class="form-control" name="keyword" placeholder="Ex: Choose your city or location">
      ...
      <div class="col-lg-10">
        ...
        <?php if($allcategories->num_rows()>0){
          ...
          foreach($allcategories->result() as $row){ ?>
            <div class="item">
              <a class="category-item bg-holder bg-overlay-black-50 text-center" style="background: cadetblue;" href="<?php echo base_url('ViewCategory/'.$row->Category) ?>">
    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          <h2>Most Common places near you <a class="btn btn-primary btnsm pull-right" href="<?php echo base_url('') ?>" style="border-radius:0px;"> VIEW ALL </a></h2>
            ...
            <div class="listing-details">
              <div class="listing-details-inner">
                ...
                <div class="listing-rating-call">
                  <a class="listing-rating" href="index.html#"><span>4.6</span> 10 Ratings</a>
                  <a class="listing-call" href="index.html#"><i class="fas fa-phone-volume"></i> <?php echo $row->Category ?></a>
                </div>
